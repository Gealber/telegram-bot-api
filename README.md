...
[![Go Reference](https://pkg.go.dev/badge/github.com/Gealber/telegram-bot-api/v5.svg)](https://pkg.go.dev/github.com/Gealber/telegram-bot-api/v5)
...
All methods are fairly self-explanatory, and reading the [godoc](https://pkg.go.dev/github.com/Gealber/telegram-bot-api/v5) page should
...
`go get -u github.com/Gealber/telegram-bot-api/v5`.
...
import (
	...
	"github.com/Gealber/telegram-bot-api/v5"
)
